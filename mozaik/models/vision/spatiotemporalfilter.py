...
class SpatioTemporalFilterRGCandLGN(SpatioTemporalFilterRGC):
    ...
    def init_sheets(self, model):
        ...
        for rf_type in self.rf_types:
            # LGN
            cell_params = ParameterSet(self.parameters.LGN_cell_params)
            cell_params['native_nest'] = False 
            ...
            sim.Projection(
                ...
                p.pop,
                method,
                synapse_type=sim.StaticSynapse(weight=self.parameters.retino_thalamic_weight, delay=1),
                label=rf_type,
