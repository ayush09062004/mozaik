    ...
    def perform_analysis(self, start=None, end=None):
        for sheet in self.datastore.sheets():
            ...
            for i, s in enumerate(st):
                s.duration = end - start  # direct assignment, no need to re-assign list item

            # transform spike trains due to stimuli to mean_rates
...
class SpikeCountCutout(Analysis):
    ...
    def perform_analysis(self):
        # Changed print statement to Python 3 syntax
